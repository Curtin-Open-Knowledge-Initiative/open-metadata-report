...
SELECT
  ...
  mesh.mesh,
  authors.authors,
  STRUCT(journal.JournalId, journal.DisplayName, journal.Issn, journal.Publisher{additional_source_journal_fields}) as journal,
